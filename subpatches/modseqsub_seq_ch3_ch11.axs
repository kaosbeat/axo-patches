<patch-1.0 appVersion="1.0.12">
   <comment type="patch/comment" x="56" y="70" text="set midi out channel to same channel as parent midi channel for step display"/>
   <obj type="midi/out/note" uuid="a76ae870da278cbbce5501a57ce7bd0e0ea4215c" name="note_2" x="798" y="84">
      <params/>
      <attribs>
   ...
   <obj type="math/div 64" uuid="da82c8ea54e956811f1d7264d921628e3301971e" name="div_1" x="560" y="112">
      <params/>
      <attribs/>
   </obj>
   <obj type="math/*" uuid="922423f2db9f222aa3e5ba095778288c446da47a" name="*_1" x="644" y="112">
      <params/>
      <attribs/>
   </obj>
   <obj type="math/muls 2" uuid="e6a3d49dd255fdecb3dca9c7fa75b9a95ecfd7fd" name="muls_1" x="714" y="112">
      <params/>
      <attribs/>
   </obj>
   <patcher type="patch/patcher" uuid="56e9369a-d8be-4899-9058-846d7817c275" name="octaveselector" x="294" y="126">
      <params/>
      <attribs/>
   ...
   <obj type="patch/inlet f" uuid="5c585d2dcd9c05631e345ac09626a22a639d7c13" name="midivol" x="14" y="182">
      <params/>
      <attribs/>
   </obj>
   ...
   <comment type="patch/comment" x="756" y="224" text="stepmixer faders"/>
   <comment type="patch/comment" x="154" y="238" text="clock divider"/>
   <comment type="patch/comment" x="294" y="238" text="midi note offset"/>
   <obj type="drj/seq/stepseq_8_u" uuid="948523ea71e103abc56ff0c14bff9c17972947ac" name="stepseq_8_u_2" x="756" y="238">
      <params>
   ...
   <patcher type="patch/patcher" uuid="8a05a858-dcd1-4351-b60d-88005cb48763" name="clock divider" x="98" y="252">
      <params/>
      <attribs/>
      <subpatch appVersion="1.0.12">
   ...
   <obj type="math/+" uuid="44553fdc8628c67ab535845ed1be304ad6c9553b" name="+_1" x="448" y="252">
      <params/>
      <attribs/>
   </obj>
   ...
   <comment type="patch/comment" x="756" y="616" text="launchpad step display"/>
   ...
   <obj type="drj/seq/stepseq_8_b" uuid="ae8548ea713123fd356ff0c14bff9cff999947ac" name="stepseq_8_b_6" x="756" y="630">
      <params>
   ...
   <obj type="midi/out/note" uuid="a76ae870da278cbbce5501a57ce7bd0e0ea4215c" name="note_5" x="1148" y="714">
      <params/>
      <attribs>
   ...
   <obj type="midi/out/note" uuid="a76ae870da278cbbce5501a57ce7bd0e0ea4215c" name="note_1" x="1148" y="826">
      <params/>
      <attribs>
   ...
   <nets>
      ...
      <net>
         <source obj="midivol" outlet="inlet"/>
         <dest obj="div_1" inlet="in"/>
      </net>
   </nets>
   <settings>
